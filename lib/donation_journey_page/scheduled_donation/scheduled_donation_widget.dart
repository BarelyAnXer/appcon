...
class ScheduledDonationWidget extends StatefulWidget {
  const ScheduledDonationWidget({
    super.key,
    required this.bloodstockref,
    required this.bloodCenterUserRef,
  });

  final DocumentReference? bloodstockref;
  final DocumentReference? bloodCenterUserRef;
...
class _ScheduledDonationWidgetState extends State<ScheduledDonationWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BloodStocksRecord>(
      stream: BloodStocksRecord.getDocument(widget.bloodstockref!),
      builder: (context, snapshot) {
        ...
        final scheduledDonationBloodStocksRecord = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Padding(
                ...
                child: StreamBuilder<UsersRecord>(
                  stream: UsersRecord.getDocument(widget.bloodCenterUserRef!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        dateTimeFormat(
                                            'yMMMd',
                                            scheduledDonationBloodStocksRecord
                                                .appointmentdate!),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          5.0, 0.0, 5.0, 0.0),
                                      child: Text(
                                        '${columnUsersRecord.companyProvince} ${columnUsersRecord.companyCity} ${columnUsersRecord.companyBarangay}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
