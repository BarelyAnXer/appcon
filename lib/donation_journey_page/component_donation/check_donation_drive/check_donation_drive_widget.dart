...
class CheckDonationDriveWidget extends StatefulWidget {
  const CheckDonationDriveWidget({super.key});
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Dugo, Dugo, Dugo. Ikaw ang aking Gusto! Yiieeeeee Kilergs',
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          10.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'Full Address A Whole New World A New Fantastic Point of View',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
                                          ...
                                          builder: (context) {
                                            return Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child: const DonationSurenessWidget(),
                                            );
                                          },
