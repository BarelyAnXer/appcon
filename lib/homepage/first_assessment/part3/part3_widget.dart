...
class _Part3WidgetState extends State<Part3Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.yesOrNo = FFAppState().part3.yesOrNo.toList().cast<int>();
        _model.remarks = FFAppState().part3.remarks.toList().cast<String>();
        _model.counter = FFAppState().part3.counter;
      });
    });
