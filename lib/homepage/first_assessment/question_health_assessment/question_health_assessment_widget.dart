...
import 'question_health_assessment_model.dart';
export 'question_health_assessment_model.dart';

class QuestionHealthAssessmentWidget extends StatefulWidget {
  const QuestionHealthAssessmentWidget({super.key});

  @override
  State<QuestionHealthAssessmentWidget> createState() =>
      _QuestionHealthAssessmentWidgetState();
}

class _QuestionHealthAssessmentWidgetState
    extends State<QuestionHealthAssessmentWidget> {
  late QuestionHealthAssessmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuestionHealthAssessmentModel());
