...
class _Part1WidgetState extends State<Part1Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.yesOrNo = FFAppState().part1.yesOrNo.toList().cast<int>();
        _model.remarks =
            currentUserDocument!.part1.remarks.toList().cast<String>();
        _model.counter = FFAppState().part1.counter;
      });
      if (widget.counter != null) {
        setState(() {
          _model.counter = widget.counter;
        });
        setState(() {
          FFAppState().updatePart1Struct(
            (e) => e..counter = widget.counter,
          );
        });
      }
    });
